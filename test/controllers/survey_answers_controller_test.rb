...
class SurveyAnswersControllerTest < ActionController::TestCase
  ...
  test "should create survey_answer" do
    assert_difference('SurveyAnswer.count') do
      post :create, survey_answer: { answer_text: @survey_answer.answer_text, attendee_id: @survey_answer.attendee_id, event_id: @survey_answer.event_id, survey_question_id: @survey_answer.survey_question_id }
    end
  ...
  test "should update survey_answer" do
    patch :update, id: @survey_answer, survey_answer: { answer_text: @survey_answer.answer_text, attendee_id: @survey_answer.attendee_id, event_id: @survey_answer.event_id, survey_question_id: @survey_answer.survey_question_id }
    assert_redirected_to survey_answer_path(assigns(:survey_answer))
  end
