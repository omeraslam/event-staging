...
class BuyersControllerTest < ActionController::TestCase
  ...
  test "should create buyer" do
    assert_difference('Buyer.count') do
      post :create, buyer: { email: @buyer.email, first_name: @buyer.first_name, last_name: @buyer.last_name }
    end
  ...
  test "should update buyer" do
    patch :update, id: @buyer, buyer: { email: @buyer.email, first_name: @buyer.first_name, last_name: @buyer.last_name }
    assert_redirected_to buyer_path(assigns(:buyer))
  end
