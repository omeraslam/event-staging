var EditorSectionFormContainer = React.createClass({
    getInitialState: function() {
        return { current_selection: null, eventObj: this.props.eventObj, ticketObj: this.props.ticketObj, onPanelUpdate: this.props.onPanelUpdate}
    },    
   ...
   render: function() {
        if(this.state.current_selection != null) {
            switch(this.state.current_selection["category"]) {
                ...
                break;
                case 'tickets':
                var sectionContent =  <EventTicketingForm header="Edit Registration + Ticketing settings" subheader="Manage your event registration settings here." eventObj={this.state.eventObj} ticketObj={this.state.ticketObj} onPanelUpdate={this.props.onPanelUpdate}  />;
                break;
                case 'url':
                ...
                // break;
                case 'payment':
                var sectionContent =  <EventPaymentForm header="Edit Payment settings" subheader="Connect to Stripe and choose your country's currency here."  eventObj={this.state.eventObj} onPanelUpdate={this.props.onPanelUpdate}  />;
                break;
                default:
                var sectionContent =  <EventDetailsForm header="Edit event settings" subheader="Change of venue? Modify your event details here." eventObj={this.state.eventObj} onPanelUpdate={this.props.onPanelUpdate}  />;
                break;
