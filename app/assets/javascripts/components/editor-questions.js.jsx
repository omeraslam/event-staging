    ...
    render: function() {
        return (
             ...
             <div className="editor-tool editor-panel-left-nav" id="editor-tool-questions" >
               <EditorSection items={this.state.items} event_id={this.props.event_id} current_selection={this.state.current_selection} event_slug={this.state.event_slug} category={this.state.category} />
